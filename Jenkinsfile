      ...
      stage("Protractor testing"){
        steps {
          dir ("./test") {
              ...
              sh "sudo docker run -v /home/ubuntu/workspace/Ethereum-DevOps-Demo/test/test/conf/allure-results:/test/conf/allure-results -e ETH_APP_URL=$ETH_APP_URL --name protractor protractor"
          }
        }
      }  
    }
